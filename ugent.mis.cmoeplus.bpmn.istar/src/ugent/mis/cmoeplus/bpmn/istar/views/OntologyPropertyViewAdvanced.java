...
public class OntologyPropertyViewAdvanced extends ViewPart {

	private TableViewer tableViewer;
	final static public String ID = "ugent.mis.cmoeplus.bpmn.istar.ontpropadv";
	...
	public String[] createPropertyArray(Recommendation sug) {
