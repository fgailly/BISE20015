...
public class BPMNOntologyPerspective implements IPerspectiveFactory {

	public static final String ID = "org.eclipse.bpmn2.modeler.suggestion.perspectives.BPMNOntologyPerspective";
	...
	public void createInitialLayout(IPageLayout layout) {
		...
		layout.addView(OntologyID, IPageLayout.RIGHT, 0.45f, IPageLayout.ID_PROP_SHEET);
		layout.addView(OntologyPropID, IPageLayout.RIGHT, 0.40f, OntologyID);
